# Native Blender animation

Scripted authoring in Blender, with persistent meshes, armatures, pose keys, and native rendering. Each project retains an editable `.blend`, render frames, a preview, and review evidence. This workflow is separate from generated-cel animation and Deforum repainting.
