...
Latest direct-motion result: [twist, turn and ripple](projects/motion-guide-study/experiments/spatial-sequence.md), one nine-second cadence-3 sequence with and without RIFE. Videos are local and cloud resources cleaned up; human playback feedback is pending.
