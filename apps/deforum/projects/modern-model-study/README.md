...
Latest: [independent ten-dollar filmmaking session](experiments/ten-dollar.md) auditions a brass watch becoming a snail, an underwater parasol becoming a jellyfish, and the accepted owl becoming a mechanical lion. The assistant selects the stronger-noise watch transition plus the two other subjects. All 60 new generated images and 992 archive files are verified locally; the owned Pod is deleted, model cache retained. Estimated incremental session cost is about $0.20; final billing was not yet posted at cleanup. Olof's playback feedback on these new clips is pending.
