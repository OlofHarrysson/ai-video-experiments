...
Latest: [dynamic scene journey](experiments/dynamic-journey.md) delivers a [24-second film](exports/dynamic-journey-v001/ramped/film/preview.mp4): watch/snail → canyon city → underwater garden → cloud palaces → cosmic mountains. Three probes favor a gradual transition-noise ramp; human playback feedback is pending. Recurrent feedback and overlapping bounded motion stay intact. All 56 new paintings/924 archive files and the 576-frame delivery are verified locally. Owned A100 deleted, model cache retained; retry cost is approximately $0.87 including a disk allowance, with billing unposted. See [cut v004](cuts/v004.md).
