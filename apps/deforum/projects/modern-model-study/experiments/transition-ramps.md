...
The owned Pod was deleted after approximately 22 minutes, and an empty Pod list was confirmed. The authorized EU model volume remains. Estimated compute is **$0.5826**, plus a conservative **$0.03 disk allowance**, about **$0.61**; this Pod's billing was unposted at cleanup. The prompt-bridge follow-up subsequently confirmed $0.5873 posted ($0.5826 compute and $0.0046 disk). Previous successful sessions posted $0.1743 and $0.8445. Including a $0.25 allowance for the earlier startup failure, the tracked session total is approximately $1.88 within the original $10 budget; retained-volume ongoing storage is separate.
