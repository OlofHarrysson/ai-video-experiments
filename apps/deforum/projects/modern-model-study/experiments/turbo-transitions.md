...
Olof explicitly wants smooth morphing rather than flickering: keep the interesting evolution while making transitions gradual. Keep the richer three-step output as the creative reference. Distinguish interpolated smoothness, lighting/texture flicker, motion fidelity and actual model consistency. No new render or cloud resource was started for this discussion.
