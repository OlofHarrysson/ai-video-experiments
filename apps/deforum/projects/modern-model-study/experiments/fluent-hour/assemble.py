...
def assemble(case):
    if case == "f5-the-dreaming-moon":
        parts = [
            (
                lab.OUT.parent
                / "story-hour-v001/t7-through-the-living-book/faster/rife",
                256,
                0,
            ),
            (lab.OUT / "f1-arcing-route/excerpt-0384/rife-moving-tail", 248, 32),
            (lab.OUT / case / "excerpt-0756/rife-moving-tail", 200, 63),
        ]
    elif case == "f6-the-orbital-railway":
        parts = [
            (lab.OUT / "f3-sweeping-worlds/faster/rife-moving-tail", 376, 0),
            (lab.OUT / case / "excerpt-0564/rife-moving-tail", 136, 47),
        ]
    else:
...
if __name__ == "__main__":
    ...
    p.add_argument("case", choices=["f5-the-dreaming-moon", "f6-the-orbital-railway"])
