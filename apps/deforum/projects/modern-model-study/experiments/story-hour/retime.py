...
def retime(case, stage, first_frame=0):
    source = lab.OUT / case
    ...
    old_count = round(config["duration"] * 24) - first_frame
    assert old_count % 3 == 0
    count = old_count * 2 // 3
    root = source / (f"excerpt-{first_frame:04d}" if first_frame else "faster")
...
if __name__ == "__main__":
    ...
    retime(args.case, args.stage, args.from_frame)
