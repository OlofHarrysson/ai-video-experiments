"""Verify the two matched RGB-feedback schedule animations."""
import copy
import json
import subprocess
import numpy as np
from PIL import Image, ImageDraw, ImageFont
import turbo_schedule_motion as c
...
def main():
    ...
    sources=[c.OUT/'small-updates',c.OUT/'turbo-tail']
    labels=['Eight small updates | same twist','Turbo final step | same twist']
    ...
    print('Verified both schedule animations, all 22 anchors and comparison')
