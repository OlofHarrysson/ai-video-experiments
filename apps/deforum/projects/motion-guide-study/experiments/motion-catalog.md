...
The archived Safety Marc library contains 95 variants, including 77 with optical-flow motion and 50 with inferred depth. Many are combinations of camera schedules, guide motion, compositing and generation settings; they are not 95 independent transforms. Olof selected **direct effects now; original mechanisms later**. This browser therefore contains 23 direct examples, not reproductions of all 95 presets. Related-source links associate motion ideas; they do not claim equivalent schedules, strength, guide fields or output.

## Delivered browser

Canonical source: [motion_catalog.html](../../../motion_catalog.html). It is a self-contained inline visualization fragment; the host supplies theme/control styles. A frozen [local copy](../exports/spatial-effects-v001/spatial-effects.html) and [manifest](../exports/spatial-effects-v001/manifest.json) preserve this version. The browser is surfaced in chat with a single drawing, grouped selector, six-second playback and time scrubbing. Choosing an effect resets time to zero and pauses. Playback is manual and stops at the end; Replay starts again.

| Group | Selectable effects |
| --- | --- |
| Local reshaping | Grow around the sun; Grow around the house; Pinch around the sun; Make the sun breathe; Open the center sideways; Send a ripple outward |
