...
- Current visual task: [study Tomorrow and Brain Entity](apps/deforum/projects/reference-studies/README.md), then reproduce a short sample of their visual qualities. Olof likes both and says the current marsh style is not good enough. Prioritize a convincing art reference match before further broad settings sweeps; models/settings may differ from the originals. Reference studies are completed; recreation is proposed, not rendered.
