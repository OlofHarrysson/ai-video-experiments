...
- Current visual task: [Brain Entity reproduction](apps/deforum/projects/brain-entity-study/README.md). Olof tentatively prefers **P3 + RIFE** from the continuity round; C01/C03 were boring and the others pretty good, but similar variants were difficult to distinguish. Use P3 + RIFE as the current creative baseline. [RIFE finishing](apps/deforum/projects/brain-entity-study/experiments/rife-results.md) runs locally on MPS in about 16 seconds per six-second clip; interpolated noise during generation remains untested.
