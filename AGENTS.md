...
- Current visual task: [Brain Entity reproduction](apps/deforum/projects/brain-entity-study/README.md), following the [Tomorrow and Brain Entity reference studies](apps/deforum/projects/reference-studies/README.md). Six stills and eight six-second videos are local. Olof prefers v002 but says it is still not great. Six [controlled comparisons](apps/deforum/projects/brain-entity-study/experiments/parameters.md) isolate guide, denoise, CFG, steps, noise and prompt travel. Olof finds P06 clear but slideshow-like; P01/P03 and likely P04 have preferred morphing. Prioritize more gradual transitions while retaining the improved artwork. The [architecture comparison](docs/research/deforum-architecture-comparison.md) identifies omitted interpolation and noise-continuity mechanisms; research recommendations await implementation.
...
- Inspect generated clips with `apps/deforum/video_review.py`: timestamped overview frames first, targeted event context next. Keep review artifacts beside project media. Scene-change candidates are pixel heuristics; sampled frames alone do not establish playback quality. See [local video review](docs/video-review.md).
