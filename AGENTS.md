...
- First milestone: three five-second SDXL clips with the same seed and camera path at different denoise strengths.
- Main unknown: whether the existing workflow produces compelling animation without degrading into blur. Verify a short render before extending it or changing models.
