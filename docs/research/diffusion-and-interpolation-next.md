...
Recommendation awaiting alignment: first the 0.60 three-interval repaint branch; then, if desired, the bounded SPEED interpolation audition on unchanged saved paintings. This research authorizes no pipeline replacement and starts no new render.
