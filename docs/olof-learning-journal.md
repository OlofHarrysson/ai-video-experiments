...
**Modern-model quality feedback (2026-09-09, explicit):** Olof finds Klein more consistent than SDXL in some respects, but less cool and interesting than the SDXL results and original Deforum references. He rejects the latest Krea output, including its opening image, and asks whether prompting, tooling or model choice explains the poor quality. Consistency alone does not satisfy the artistic goal. He has not approved a new model, recipe or next experiment.
